...
function getTotalPages() {
    $.get('../controller/router.php?action=get_total_pages&type=user', function(data) {
...
function loadPosts(page = 1) {
    ...
    // 根据页码加载文章
    $.getJSON(`../controller/router.php?action=get_posts&type=user&page=${page}`, function(data) {
